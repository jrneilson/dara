...
def cif2str(
    ...
    *,
    ...
    Args:
        ...
        phase_name_preffix: the prefix of the phase name
    ...
    # add some metadata
    # max length of a phase is 10 char for the par parser.
    phase_name = process_phase_name(phase_name_preffix + cif_path.stem, max_length=10)
